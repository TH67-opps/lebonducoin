...
<body>
    ...
    <nav class="navbar nav-underline fixed-top navbar-expand-lg bg-body-tertiary shadow p-3 mb-1 bg-body-tertiary rounded">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link" href="mes_annonces.php"><i class="fas fa-list"></i> Mes annonces</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- fin barre de catégorie --> 
    <hr>

    <!-- Section de débogage (peut être supprimée après résolution du problème) -->
